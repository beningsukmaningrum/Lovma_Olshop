                        ...
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="<?= base_url('assets/uploads/produk/') . $brg['foto_produk']; ?>">
                                ...
                                <ul class="product__hover">
                                    ...
                                    <li> <a href="<?php echo base_url('OT/Login') ?>"> <span class=" icon_bag_alt"></span></li>

                                </ul>
                            </div>
                            <div class="product__item__text">
                                <h6><a href=""><?php echo $brg['nama_produk']; ?></a></h6>
                                <!-- <div class="rating">
                                ...
                                <div class="product__price">Rp. <?= $brg['harga_produk']; ?></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
